...
!!! success "解"
    ...
    $$
    \begin{aligned}
    I = \displaystyle\int_{0}^{\frac{\pi}{2}} \ln(\sin x)\mathrm{d}x &= \displaystyle\int_{0}^{\frac{\pi}{4}} \ln\left(\dfrac{1}{2}\sin 2x\right)\mathrm{d}x \xrightarrow{2x \to x} -\dfrac{\pi}{4}\ln 2 + \dfrac{1}{2}\displaystyle\int_{0}^{\frac{\pi}{2}} \ln(\sin x)\mathrm{d}x \\
